...
for epoch in range(args.max_epochs):
    ...
    for batch, x in enumerate(dataloader):
        ...
        x = x[0]
        x_interpolated = nn.functional.interpolate(x, size=16, mode="bilinear")
